const App = angular
  .module('myApp', ['ngRoute', 'UserProfileController', 'ActivitiesController', 'notFoundActController',
    'LoginController', 'MatchController', 'ContactController', 'EventFactory', 'UserFactory', 'ClickedFactory']
);
